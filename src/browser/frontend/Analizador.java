...
public class Analizador extends javax.swing.JFrame {
    ...
    private void jMenuItemSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSaveActionPerformed
        ManejadorAnalizador.getInstance().guardarArchivo(jTabbedPane.getSelectedIndex());
    ...
    private void jMenuItemOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemOpenActionPerformed
        ManejadorAnalizador.getInstance().abrirDocumento(jTabbedPane.getComponentCount());
    }//GEN-LAST:event_jMenuItemOpenActionPerformed

    private void jMenuItemSaveAsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSaveAsActionPerformed
        ManejadorAnalizador.getInstance().guardarArchivoComo(0, 0);
